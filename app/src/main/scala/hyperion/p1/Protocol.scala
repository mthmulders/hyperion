...
/**
  ...
  */
final case class TelegramReceived(telegram: P1Telegram)
...
/**
  ...
  */
final case class P1Telegram(header: P1Header,
                            metadata: P1MetaData,
                            data: P1Data,
                            checksum: String)
...
/**
  ...
  */
final case class P1Header(make: String,
...
/**
  ...
  */
final case class P1MetaData(versionInfo: String,
...
/**
  ...
  */
final case class P1Data(currentTariff: String,
...
/**
  ...
  */
final case class P1UnknownDevice(id: Int, deviceType: String) extends P1ExtraDevice
...
/**
  ...
  */
final case class P1GasMeter(id: Int,
                            equipmentIdentifier: String,
